...
public class TodoApp extends Application {
    ...
    private VBox buildInputPanel() {
        ...
        // --- Butonlar ---
        Button addBtn    = actionButton("Yeni Görev Ekle",         "#a6e3a1", "#1e1e2e");
        Button doneBtn   = actionButton("Görev Tamamla",       "#89b4fa", "#1e1e2e");
        Button deleteBtn = actionButton("Görev Sil",           "#f38ba8", "#1e1e2e");
        ...
        Button treeBtn   = actionButton(" Ağaç görünümüne git", "#f2cdcd", "#1e1e2e"); // ← YENİ
